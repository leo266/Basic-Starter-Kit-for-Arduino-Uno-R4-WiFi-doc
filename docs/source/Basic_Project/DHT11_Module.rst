...
.. image:: img/DHT11_Module_Wiring.png
    :align: center
...
.. note::
    ...
    * You can open the file ``09_DHT11_Module.ino`` under the path of ``Basic-Starter-Kit-for-Arduino-Uno-R4-WiFi-main\Code`` directly.
...
#. Main loop.
   ...
   .. note::
      ...
      The `heat_index <https://en.wikipedia.org/wiki/Heat_index>`_ is a way to measure how hot it feels outside by combining the air temperature and the humidity. It is also called the "felt air temperature" or "apparent temperature".
